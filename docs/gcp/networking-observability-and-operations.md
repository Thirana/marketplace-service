...
This note explains how the deployed services should be exposed, observed, and operated on Google Cloud.
...
This application already exposes:
...
This means the repository currently only documents the target platform shape rather than implementing it.
